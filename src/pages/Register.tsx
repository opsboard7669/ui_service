...
import { UserPlus, Lock, AlertCircle, UserCircle, Check, Layout, BarChart3, KanbanSquare, Zap, Shield, Cloud, Clock, Award, User, Mail } from 'lucide-react'
          ...
          <div className={`w-full max-w-md mx-auto lg:mx-0 lg:-mt-4 opacity-0 ${mounted ? 'fade-in-up' : ''}`}>
            <div className="premium-glass-card">
              <div className="mb-5">
                ...
                <p className="text-sm text-gray-400">Join your team's workspace.</p>
              </div>
              ...
              <p className="mt-4 text-center text-sm text-gray-400">
                ...
                <Link to="/login" className="text-[#22c55e] hover:text-[#16a34a] font-medium transition-colors cursor-pointer">
                  Sign in
                </Link>
              </p>
            </div>
